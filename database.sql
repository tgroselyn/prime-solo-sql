...
VALUES ('thomas', 'minneapolis', 13, 18, '49.00');
...
-- (update anthony's city value to 'sante fe')
UPDATE "accounts"
SET "city" = 'sante fe'
WHERE "username" = 'anthony';

-- Grace closed her account.
-- (delete Grace's row in table)
DELETE FROM "accounts"
...
ALTER TABLE "accounts" ADD COLUMN "lastname" varchar(40);